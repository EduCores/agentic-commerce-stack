  ...
  try {
    ...
    if (DEMO_MODE && runs.length === 0) {
      ...
      return NextResponse.json({
        ...
        byDay: demoByDay,
        table: [
          { id: "1", name: "Asistente Ventas", slug: "sales-assistant", model: "qwen/qwen3-30b", active: true, requests: 12, success: 96.4, cost: 10.8, revenue: 420000 },
          { id: "2", name: "Soporte Checkout", slug: "checkout-support", model: "qwen/qwen3-30b", active: true, requests: 8, success: 96.4, cost: 7.2, revenue: 280000 },
        ],
        // Fake demo (quitar en entrega)
        byModel: [
          { model: "qwen/qwen3-30b", requests: 32, cost: 28.8, revenue: 890000 },
