...
import { ACSFloatingButtons } from "@/components/chat/acs-floating-buttons";
  ...
  return (
    <div className="flex h-full">
      ...
      <div className={cn("min-w-0 flex-1", isSidebarOpen ? "lg:p-4 xl:pr-4" : "lg:py-4 xl:px-4")}>
        <div className="flex h-full flex-col overflow-hidden border border-card-surface-border bg-card-surface-area lg:rounded-2xl lg:shadow-[0_3px_6px_-2px_rgba(0,0,0,0.02),0_1px_1px_0_rgba(0,0,0,0.04)]">
      ...
      {/* ACS — Widget idéntico a StarShop (https://starshop-rho.vercel.app/) */}
      <ACSFloatingButtons />
    </div>
  );
}
