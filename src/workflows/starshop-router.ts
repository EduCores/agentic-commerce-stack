...
export const starShopRouterGraph = {
  nodes: [
    ...
    { id: "crew-support", type: "base", position: { x: 300, y: 280 }, data: { label: "3 Soporte general", description: "Responde políticas, envíos y garantías; scrapea la política real (id_cms=1) si falta información.", detail: "Tools: scrapeWebsite, navigateTo. Nunca inventa políticas; si no encuentra, escala a ventas@starshop.cl.", type: "agent_decision", status: "idle", agent: "StarShop Support Agent", tools: STARSHOP_CREW_TOOLS.general_inquiry, prompt: STARSHOP_CREWS.general_support.prompt, intent: "general_inquiry", model: STARSHOP_CREWS.general_support.model } },
