        ...
        <div className='flex h-full flex-col overflow-hidden'>
            ...
            <div
                className={cn(
                    ...
                    isMobileSheet ? 'gap-2 pl-4 pr-3 pt-7' : 'px-4 pt-7',
                )}
            >
                <Link href='/' suppressHydrationWarning aria-label="Ir al panel principal" className={isMobileSheet ? 'min-w-0 flex-1' : undefined}>
